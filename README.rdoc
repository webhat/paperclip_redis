...
{<img src="https://travis-ci.org/webhat/paperclip_redis.png?branch=master" alt='Travis Build Status' />}[https://travis-ci.org/webhat/oplerno]  
...
Copyright (c) 2014 Daniël W. Crompton. See LICENSE.txt for
further details.
